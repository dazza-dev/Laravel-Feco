...
class Common
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prefix' => ['required', 'string', 'max:4', 'same:numbering_range.prefix'],
            'number' => ['required', 'numeric'],
            'date' => ['required', 'date_format:Y-m-d\TH:i:sP'],
            'due_date' => ['nullable', 'date_format:Y-m-d\TH:i:sP', 'after_or_equal:date'],
    ...
    public function messages(): array
    {
        return [
            ...
            'prefix.same' => 'El prefijo no coincide con el código de la sucursal.',
